    ...
    def train(self):
        ...
        for epoch in range(self._max_epochs):
            ...
            self._logger.info(message.format(epoch + 1, mtrain_loss1, mtrain_rmse1, mtrain_mape1, \
                                             ...
                                             (t2 - t1), (v2 - v1), cur_lr))
            message = 'Epoch: {:03d}, Valid Loss: {:.4f}, Valid RMSE: {:.4f}, Valid MAPE: {:.4f}, Train Time: {:.4f}s/epoch, Valid Time: {:.4f}s, LR: {:.4e}'
            self._logger.info(message.format(epoch + 1, mvalid_loss2, mvalid_rmse2, mvalid_mape2, \
                                             (t2 - t1), (v2 - v1), cur_lr))
